                ...
                script {
                    timeout(time: 15, unit: "MINUTES"){
                        ...
                        sh """
                            ...
                            # ${npmHome}/bin/npm install --max_old_space_size=3072
                            ${npmHome}/bin/npm i --package-lock-only --max_old_space_size=3072
                            ${npmHome}/bin/npm ci --max_old_space_size=3072
                ...
                script {
                    timeout(time: 15, unit: "MINUTES"){
                        ...
                        sh """
                            export NODE_HOME=${npmHome}
                            export PATH=\$NODE_HOME/bin:\$PATH
                            ${npmHome}/bin/npm run build --max_old_space_size=3072
